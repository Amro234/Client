...
import java.net.URL;
import java.util.ResourceBundimport avafx.event.ActionEvent;
...
public class DifficultyController implements Initializable {
     ...
     */
    @FXML
    private void onCardHover(MouseE
    ...
    private void onCardClick(MouseEvent event) {
        ...
        setCardSelected(clickedCard, true);
           ...
           selectedDifficulty = Difficulty.EASY;lickedCard == mediumCard) {Difficulty = Difficulty.MEDIUM;
